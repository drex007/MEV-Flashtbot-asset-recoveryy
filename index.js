...
const main = async () => {
    ...
    if (SPONSOR_KEY === undefined || VICTIM_KEY === undefined || EVM_RPC_URL === undefined || CONTRACT_ADDRESS === undefined || RECIPIENT_ADDRESS === undefined) {
        console.error("Please set keys SPONSOR_KEY,VICTIM_KEY, CONTRACT_ADDRESS, CHAIN_ID, TOKEN_ID, RECIPIENT_ADDRESS and EVM_RPC_URL")
        exit(1)
    }
    ...
    try {
        ...
        const contractABi = ["function transferFrom(address from, address to, uint256 tokenId)"]
        ...
        const transactions = [
            //Send TransactionFee to Victims Wallart
            {
            ...
            //Transfer NFT
            {
                ...
                transaction: {
                    ...
                    to: CONTRACT_ADDRESS,
                    gasLimit: 50000,
                    data: contractInterface.encodeFunctionData("transferFrom", [
                        victim_connect.address,
                        RECIPIENT_ADDRESS,
                        TOKEN_ID
